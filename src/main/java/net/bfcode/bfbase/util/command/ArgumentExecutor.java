package net.bfcode.bfbase.util.command;
...
public abstract class ArgumentExecutor implements CommandExecutor, TabCompleter {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		if (args.length < 1) {
			...
			sender.sendMessage(ChatColor.DARK_AQUA.toString() + ChatColor.BOLD + WordUtils.capitalizeFully(label)
					+ ChatColor.DARK_AQUA.toString() + ChatColor.BOLD + " Help" + ChatColor.GRAY
					+ " (Page 1 out of 1)");
			sender.sendMessage(" ");
			for (CommandArgument argument : this.arguments) {
